...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-CD0RD68\\SQLEXPRESS;Database=HealthInsurance3;User Id=kevin;Password=123456;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Policy>(entity =>
        {
            ...
            entity.HasOne(d => d.Hospital).WithMany(p => p.Policies)
        ...
        modelBuilder.Entity<PolicyRequestDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.PolicyRequestDetails)
                .HasForeignKey(d => d.CompanyId)
                .HasConstraintName("FK_PolicyRequestDetails_InsuranceCompany");

            entity.HasOne(d => d.Employee).WithMany(p => p.PolicyRequestDetailEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("FK_PolicyRequestDetails_Employee2");

            entity.HasOne(d => d.Manager).WithMany(p => p.PolicyRequestDetailManagers)
                .HasForeignKey(d => d.ManagerId)
                .HasConstraintName("FK_PolicyRequestDetails_Employee");

            entity.HasOne(d => d.Policy).WithMany(p => p.PolicyRequestDetails)
                .HasForeignKey(d => d.PolicyId)
